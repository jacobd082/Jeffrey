...
no_no_word = ["this contains cuss words."]
...
async def on_message(message):
  ...
  if message.content.startswith('/about'):
    await message.channel.send('Hello! Im Jeffrey! Im a bot coded in Python by Jacob Drath! Heres my links: https://sites.google.com/view/jeffrey-the-discord-bot/links Currently Im Closed-Sourced. Ask my creater @jacobd082 for how to get me in your server!')
